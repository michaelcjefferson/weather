...
/***/ function(module, exports, __webpack_require__) {
	...
	var _weather_info = __webpack_require__(246);

	var _weather_info2 = _interopRequireDefault(_weather_info);

	var _background = __webpack_require__(247);

	var _background2 = _interopRequireDefault(_background);

	var _unit_selector = __webpack_require__(248);

	var _unit_selector2 = _interopRequireDefault(_unit_selector);

	var _search_bar = __webpack_require__(249);
	...
	var App = function (_Component) {
	  ...
	  (0, _createClass3.default)(App, [{
	    ...
	    key: 'getWeatherDataFromCoords',
	    value: function getWeatherDataFromCoords(lat, lon, placeName) {
	      var _this2 = this;

	      if (this.checkIfValidCoord(lat, lon)) {
	        $.post('/getDataFromForecast', { lat: lat, lon: lon }, function (data) {
	          if (_this2.state.weatherData != data) {
	            _this2.setState({
	              weatherData: data,
	    ...
	    key: 'setWeatherData',
	    value: function setWeatherData() {
	      var _this3 = this;

	      if (navigator.geolocation) {
	        navigator.geolocation.getCurrentPosition(function (position) {
	          _this3.getWeatherDataFromCoords(position.coords.latitude, position.coords.longitude);
	          _this3.geocoder.geocode({ 'location': { lat: position.coords.latitude, lng: position.coords.longitude }
	        ...
	        this.geocoder.geocode({ 'location': { lat: 31.2327301, lng: 121.47584 }
	        }, function (data, status) {
	          if (status === google.maps.GeocoderStatus.OK) {
	            if (data) {
	              var index = 0;
	    ...
	    key: 'checkIfValidCoord',
	    value: function checkIfValidCoord(lat, lon) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'main' },
	        _react2.default.createElement(_background2.default, { weatherType: this.state.weatherType }),
	        _react2.default.createElement(_unit_selector2.default, {
	          unit: this.state.unit,
	          onUnitSelect: function onUnitSelect(newUnit) {
	            _this4.setState({ unit: newUnit });
	          } }),
	        _react2.default.createElement(_search_bar2.default, { onPlaceUpdate: function onPlaceUpdate(lat, lon, placeName) {
	            _this4.getWeatherDataFromCoords(lat, lon, placeName);
	          } }),
	        _react2.default.createElement(_weather_info2.default, { weatherData: this.state.weatherData, unit: this.state.unit, placeName: this.state.placeName })
	      );
	    }
	  }]);
	  return App;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherInfo = function WeatherInfo(_ref) {
	  ...
	  var roundedTemp = Math.round(checkUnit(weatherData.currently.temperature, unit));
	  var weatherDescription = weatherData.currently.summary;
	  var cloudCover = Math.round(weatherData.currently.cloudCover * 100);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Background = function Background(_ref) {
	  ...
	  var weatherTypes = ['clear-day', 'clear-night', 'cloudy', 'fog', 'partly-cloudy-day', 'partly-cloudy-night', 'rain', 'sleet', 'snow', 'thunderstorm', 'wind'];
	  ...
	  var pictureUrl = createPictureUrl(weatherType);
	  var backgroundStyle = {
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: 'background-picture', style: backgroundStyle },
	    _react2.default.createElement('img', { className: 'google-logo', src: '../../img/powered_by_google_on_non_white.png' })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UnitSelector = function UnitSelector(_ref) {
	  var unit = _ref.unit;
	  var onUnitSelect = _ref.onUnitSelect;

	  var convert = function convert(unit) {
	    if (unit === 'C') {
	      return 'F';
	    } else {
	      return 'C';
	  ...
	  var newUnit = convert(unit);

	  return _react2.default.createElement(
	    'button',
	    { className: 'unit-selector', onClick: function onClick() {
	        return onUnitSelect(newUnit);
	      } },
	    'C / F'
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _prediction_list = __webpack_require__(250);

	var _prediction_list2 = _interopRequireDefault(_prediction_list);
	...
	var SearchBar = function (_Component) {
	  ...
	  function SearchBar(props) {
	    ...
	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(SearchBar).call(this, props));
	  ...
	  (0, _createClass3.default)(SearchBar, [{
	    ...
	    value: function fetchPredictions() {
	      ...
	      var options = { input: this.state.term, types: ['(cities)'] };
	    ...
	    key: 'cycleForward',
	    value: function cycleForward(currentActivePredictionNumber) {
	    ...
	    key: 'cycleBack',
	    value: function cycleBack(currentActivePredictionNumber) {
	    ...
	    value: function selectPrediction(prediction) {
	      this.placesService.getDetails({ placeId: prediction.place_id }, function (data, status) {
	        if (status === google.maps.places.PlacesServiceStatus.OK) {
	          var newPlaceData = {
	    ...
	    key: 'hidePredictions',
	    value: function hidePredictions() {
	      this.setState({
	        hidePredictions: true
	      });
	    }
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { value: this.state.term, className: 'search-field',
	        ...
	        _react2.default.createElement(
	          ...
	          { className: 'search-submit',
	            onClick: function onClick(event) {
	              event.preventDefault();
	              _this4.selectPrediction(_this4.state.activePrediction);
	            } },
	          _react2.default.createElement('i', { className: 'fa fa-search fa-2x', 'aria-hidden': 'true' })
	        ),
	        _react2.default.createElement(_prediction_list2.default, { hidePredictions: this.state.hidePredictions,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _prediction = __webpack_require__(251);

	var _prediction2 = _interopRequireDefault(_prediction);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var PredictionList = function PredictionList(_ref) {
	  var hidePredictions = _ref.hidePredictions;
	  var predictions = _ref.predictions;
	  var activePrediction = _ref.activePrediction;
	  var onPredictionSelect = _ref.onPredictionSelect;

	  var predictionListClass = '';
	  if (hidePredictions) {
	  ...
	  return _react2.default.createElement(
	    'ul',
	    { className: predictionListClass },
	    predictions.map(function (prediction) {
	      var isActive = activePrediction && prediction.place_id === activePrediction.place_id;
	      var predictionClass = '';
	      if (isActive) {
	      ...
	      return _react2.default.createElement(_prediction2.default, { key: prediction.place_id,
	        className: predictionClass,
	        prediction: prediction,
	        isActive: isActive,
	        onSelect: function onSelect() {
	          return onPredictionSelect(prediction);
	        } });
	    })
	  );
	};

	exports.default = PredictionList;
